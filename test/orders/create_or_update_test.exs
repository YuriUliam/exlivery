defmodule Exlivery.Orders.CreateOrUpdateTest do
  ...
  describe "call/1" do
    setup do
      ...
      item2 = build(:item, description: "Pizza de Peperoni", unity_price: "35.50")
    ...
    test "where there are invalid items, returns an error", %{
      user_cpf: cpf,
      item1: item1,
      item2: item2
    } do
    ...
    test "where there are no items, returns an error", %{user_cpf: cpf} do
